...
class Companies(models.Model):
    ...
    perma_link = models.CharField(db_column='PERMA_LINK', max_length=256, default='')  # Field name made lowercase.
    ...
    uuid = models.CharField(db_column='UUID', max_length=256, default='')  # Field name made lowercase.
    ...
    def __str__(self):
        ...
        "URL: " + str (self.url) + '\n' + 
        "UUID: " + str(self.uuid) + '\n' +
        "ADDRESS: " + str(self.total_funding)  + '\n' + '\n' )


class VC_data(models.Model):
    vid = models.CharField(db_column='VID', primary_key=True, max_length=255, default='')  # Field name made lowercase.
    vc_name = models.CharField(db_column='VC_NAME', max_length=256, default='')  # Field name made lowercase.
    perma_link = models.CharField(db_column='PERMA_LINK', max_length=256, default='')  # Field name made lowercase.
    image = models.CharField(db_column='IMAGE', max_length=256, blank=True, null=True)  # Field name made lowercase.
    description = models.CharField(db_column='DESCRIPTION', max_length=6000, blank=True, null=True)  # Field name made lowercase.
    url = models.CharField(db_column='URL', max_length=256, blank=True, null=True)  # Field name made lowercase.
...
class VC_Company(models.Model):
    vid = models.ForeignKey(VC_data, models.DO_NOTHING, db_column='VID')  # Field name made lowercase.
    vc_name = models.CharField(db_column='VC_NAME', max_length=256, default='')  # Field name made lowercase.
...
class VcplatformVcCompanies(models.Model):
    company_name = models.CharField(db_column='COMPANY_NAME', max_length=500)  # Field name made lowercase.
    vc_name = models.CharField(db_column='VC_NAME', max_length=500)  # Field name made lowercase.
    cid = models.ForeignKey(VcplatformCompanies, models.DO_NOTHING, db_column='CID_id')  # Field name made lowercase.
    vid = models.ForeignKey('VcplatformVcData', models.DO_NOTHING, db_column='VID_id')  # Field name made lowercase.
...
class VcplatformVcData(models.Model):
    vid = models.CharField(db_column='VID', primary_key=True, max_length=10)  # Field name made lowercase.
    vc_name = models.CharField(db_column='VC_NAME', max_length=500)  # Field name made lowercase.
    perma_link = models.CharField(db_column='PERMA_LINK', max_length=500)  # Field name made lowercase.
    image = models.CharField(db_column='IMAGE', max_length=500)  # Field name made lowercase.
    description = models.CharField(db_column='DESCRIPTION', max_length=500)  # Field name made lowercase.
